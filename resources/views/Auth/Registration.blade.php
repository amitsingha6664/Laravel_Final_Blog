...
<head>
    ...
    <title>Bootstrap 5 Registration Page</title>
    ...
    <style>
        ...
        .shapes {
            ...
            pointer-events: none;
            overflow: hidden;
            z-index: 1; /* Below the registration card */
        }
...
<body>
    ...
    <div class="registration-card text-center">
        <h2 class="mb-4">রেজিস্ট্রেশন</h2>
        <form action="{{ route('New-User-Create') }}" method="POST" id="registrationForm">
            @csrf
            <div class="form-floating mb-3">
                <input type="text" name="Full_Name" class="form-control" id="fullname" placeholder=" ">
            ...
            <div class="form-floating mb-3">
                <input type="tel" name="Phone_Number" class="form-control" id="phone" placeholder=" ">
            ...
            <div class="d-grid">
                <button type="submit" name="submit" class="btn btn-register">রেজিস্টার করুন</button>
            </div>
            <a href="{{ route('Login') }}" class="login-link">আপনার কি অ্যাকাউন্ট আছে? লগইন করুন</a>
        </form>
    </div>
