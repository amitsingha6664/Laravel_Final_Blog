        ...
        <div class="col-lg-10">
            <div class="card mb-4">
                <div class="card-header bg-white">
                    <h4 class="text-center py-3"><i class="fas fa-plus-circle me-2"></i>Create New Post</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('Post-Edit-Update', $Post->id) }}" method="POST">
                        @csrf
                        <!-- Post Title -->
                        <div class="mb-4">
                            <label for="postTitle" class="form-label">Post Title</label>
                            <input type="text" name="title" value="{{ $Post->post_title }}" class="form-control form-control-lg" id="postTitle" placeholder="Enter post title">
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <select class="form-select" id="postCategory" name="category">
                                    <option value="{{ $Post->post_category }}" selected disabled>{{ $Category_Name }}</option>
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="text" name="slug" value="{{ $Post->slug_url }}" class="form-control" id="postSlug" placeholder="Add Slug Url">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="text" name="author" value="{{ $Post->author_id }}" class="form-control" id="postAuthor" placeholder="Jhon Deo">
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea type="text" name="content" class="form-control" id="postContent" rows="10" placeholder="Write your post content here...">{{ $Post->post_description }}</textarea>
                        </div>
